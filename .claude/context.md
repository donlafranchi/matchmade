...
- Use the Read tool to load files before working
- Use the Write/Edit tools for file operations
- Use the Bash tool for git, npm, and other terminal commands
- Always run tests after implementing features
- Create commits following the git commit protocol

---

End of Claude Code context. Use the prompts above to start your session.
