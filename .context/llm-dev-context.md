...
Calm, values-first relationship builder that moves people into real life sooner. Technology behaves like a quiet host. The app reduces illusion/noise/app-dependence and supports romantic and non-romantic relationships using the same principles: honesty, alignment, real-world connection. It optimizes for conditions where chemistry can emerge; it never promises chemistry.
...
- Honest scarcity (“No matches right now”; no padding).
- Minimal messaging: coordination-only; default CTA is meeting IRL.
- Sensitive disclosures: support “off the record” + “forget that”; do not store raw sensitive text.
- Calm UI: whitespace, quiet tone; no fireworks on match reveal.
...
## Vibe & Attraction Truths (from vibes.md)

* Chemistry is discovered, not predicted. System reduces anti-vibe mismatches and gets people to meet; it does not guarantee spark.
...
* Show honest limits (“No matches right now”; “We’re still looking”) without urgency or consolation.
* Attraction UX: private, fast, photos-only; no text during attraction step; rate-limit cards to prevent feed behavior.
* Minimal messaging: coordination-focused; default CTA is meeting IRL.

## UX/Tone Cues for the Assistant

* Conversational, thoughtful, lightly self-aware; never preachy.
* Calm pacing; no hype, no countdowns, no urgency badges.
...
* Do not inflate options or feign matches; surface truthful scarcity.
* Goal is less in-app time; avoid endless chatting and dopamine loops.
...
* Honest states: “No matches right now”; “You’re close—answer 1–2 things to improve matching.”
* Match reveal + minimal coordination chat (cap messages) or quick plan; default public/group meet.
...
- Two aligned users with mutual attraction become a match; “No matches” state shows when empty.  
...
* Default to honesty in UX: show scarcity, no overpromising chemistry, no cross-mode leakage.
