...
Easy, natural, values-first relationship builder that gets people meeting in real life—where chemistry actually happens. The interface gets out of your way. The app reduces tedious work, awkward wrong-fit dates, and endless pen-pal texting. It supports romantic and non-romantic relationships using the same principles: honesty, alignment, real-world connection. It optimizes for conditions where chemistry can emerge; it never promises chemistry.
