...
### 3.9: Photo Upload (1-2 days)

**Goal:** Users can upload photos of themselves in profile view

**Steps:**
1. Add photo upload component to profile page
2. Store photos (cloud storage - Cloudflare R2 or similar)
3. Display uploaded photos in profile view
4. Handle multiple photos (3-5 max)

**Files:**
- `web/app/contexts/[context]/profile/page.tsx` - Add upload UI
- `web/app/api/photos/route.ts` - Handle upload/delete
- `web/lib/storage.ts` - Cloud storage abstraction
- Schema: Add `Photo` model linked to User

**Acceptance:**
- [ ] User can upload photos from profile view
- [ ] Photos display in profile
- [ ] Can delete photos
- [ ] Reasonable size limits (5MB per photo)

---

### 3.10: "Complete Profile to See Others" Incentive (1 day)

**Goal:** Motivate users to complete their profile by showing what's unlocked

**Steps:**
1. Add messaging in profile/discover view: "Complete your profile to view other members"
2. Show progress toward unlock (e.g., "67% complete - 33% more to see matches")
3. Gate access to other users' photos until profile is complete
4. Make this feel like anticipation, not punishment

**UX:**
- Discover tab shows blurred previews with "Complete your profile to see who's interested"
- Clear progress indicator showing what's still needed
- Once complete, photos unlock with a satisfying reveal

**Acceptance:**
- [ ] Users see incentive messaging before profile complete
- [ ] Clear progress indicator toward unlock
- [ ] Photos/matches unlock when profile hits 100%
- [ ] Feels motivating, not frustrating

---

### 3.11: Softer Onboarding Flow (1 day)

**Goal:** Ease users into the experience instead of diving straight into "what are you looking for"

**Current Problem:**
The opening message is too direct: "Cool. So you're here to meet someone you could fall for. Let's figure out what that actually looks like for you..."

This can feel intimidating or like an interrogation for new users.

**New Approach:**
1. Start with a warmer, lower-pressure greeting
2. Explain how the app works differently (no swiping, values-first)
3. Let them ask questions or express curiosity before diving in
4. Gradually transition to profile-building conversation

**New Opening Flow:**
- Message 1: "Hey! Welcome. This works a bit differently than other apps - we focus on compatibility first, and you'll actually meet people in person to see if there's chemistry. Curious how it works, or ready to jump in?"
- If curious: Explain the philosophy briefly
- If ready: "Great! Tell me a bit about yourself - what brings you here?"
- Build from there naturally

**Files:**
- `web/app/contexts/[context]/ChatProfilePanel.tsx` - Update welcome message
- `web/lib/agents/chat-agent.ts` - Adjust early-conversation prompts

**Acceptance:**
- [ ] Opening feels welcoming, not interrogating
- [ ] Users can ask questions about how it works
- [ ] Transition to profile-building feels natural
- [ ] Tested with 2-3 people for feedback
...
|------|----------|--------|
| 3.1: LLM Client | 1-2 days | ✅ Done |
| 3.2: Chat Agent | 3-4 days | ✅ Done |
| 3.3: Frontend | 1 day | ✅ Done |
| 3.4: Extraction | 2-3 days | ✅ Done |
| 3.5: Local Test (Ollama) | - | ⏭️ Skipped (model quality) |
| 3.6: VPS Setup | - | ⏭️ Skipped (using Claude API) |
| 3.7: Deployment | 1 day | Not started |
| 3.8: Beta Testing | Ongoing | Not started |
| 3.9: Photo Upload | 1-2 days | Not started |
| 3.10: Profile Incentive | 1 day | Not started |
| 3.11: Softer Onboarding | 1 day | Not started |
| **Remaining** | **5-6 days** | |
...
**Must Have:**
- [x] Agent responds to messages in real-time
- [x] Profile extracts from conversations (>70% accuracy)
- [ ] Photo upload working
- [ ] Softer onboarding flow
- [ ] 5 beta users complete full flow
- [ ] Response time <5s

**Nice to Have:**
- [ ] Streaming responses (better UX)
- [ ] Profile completion incentive (see others' photos)
